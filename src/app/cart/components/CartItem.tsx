...
const CartItem: React.FC<Props> = ({ cartItem }) => {
  ...
  return (
    <>
      <div className="bg-orange-800 grid grid-cols-6 pt-4 ">
        <div className="bg-red-500  col-span-4 md:col-span-5 md:grid md:grid-cols-5">
          <div className="bg-green-700 col-span-3 flex  md:col-span-3">
            <div className="h-[10rem] w-[10rem] shrink-0 bg-slate-600">
              <Image
                src={cartItem.imgSrc}
                width={100}
                height={100}
        ...
        <div className="bg-red-700 py-[1rem] text-[1.8rem] col-span-2 md:col-span-1">
          <p>${cartItem.total}</p>
        </div>
      </div>
    </>
